...
if (NOT AVR_SIZE_ARGS)
    if (APPLE)
        set(AVR_SIZE_ARGS -B --format=avr --mcu=${AVR_MCU})
    else(APPLE)
...
function(add_avr_executable EXECUTABLE_NAME)
    ...
    set(hex_file_output ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${hex_file})
    set(map_file_output ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${map_file})
    set(eeprom_file_output ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${eeprom_image})
