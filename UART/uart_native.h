...
#define uart_putc_ln(d)   uart0_putc_ln(d)
#define uart_puts(s)      uart0_puts(s)
#define uart_puts_ln(s)   uart0_puts_ln(s)
...
extern void uart0_putc_ln(uint8_t data);
...
extern void uart0_puts_ln(const char *s);
